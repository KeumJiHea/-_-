...
<div class="item">
	...
	<div class="items">
		<img src="<%=request.getContextPath() %>/resources/images/20220823_1_10001.jpg">
		<img src="<%=request.getContextPath() %>/resources/images/20220823_1_10002.jpg">
		<img src="<%=request.getContextPath() %>/resources/images/20220823_1_10003.jpg">
	</div>
...
<div class="item">
	...
	<div class="items">
		<img src="<%=request.getContextPath() %>/resources/images/20220823_2_20001.jpg">
		<img src="<%=request.getContextPath() %>/resources/images/20220823_2_20002.jpg">
		<img src="<%=request.getContextPath() %>/resources/images/20220823_2_20003.jpg">
	</div>
