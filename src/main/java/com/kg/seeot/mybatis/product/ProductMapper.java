...
public interface ProductMapper {
	...
	public int TestallCount(@Param("productCategorie") int productCategorie, @Param("chkColor_arr") String[] chkColor_arr, @Param("chkPrice_arr") String[] chkPrice_arr);
	public List<ProductDTO> Testprolist(@Param("orderBy") String orderBy, @Param("productCategorie") int productCategorie, @Param("start") int start, @Param("end") int end, @Param("chkColor_arr") String[] chkColor_arr, @Param("chkPrice_arr") String[] chkPrice_arr);
